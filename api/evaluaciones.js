  ...
  try {
    ...
    if (req.method === 'POST') {
      ...
      const { rows } = await sql`
        INSERT INTO evaluaciones (id, person_id, fecha, tipo, total, respuestas, comentario, evaluado_por)
        VALUES (${id}, ${personId}, ${fecha}, ${tipo}, ${total}, ${respuestasJson}, ${comentario || ''}, ${evaluadoPor})
        RETURNING *;
      `;
